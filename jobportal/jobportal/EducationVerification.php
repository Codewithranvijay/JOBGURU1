...
<!--slider--><div style="1048px; height:350px; border:solid 1px #ccc;">
...
<!-- Main Middle--><table style="width:1048px; height:auto; border:solid 1px #E6E6E6; margin:auto;">
  <tr><td>
		...
		<tr>
		<td>
		<!--TABLE 1--><table style="width:265px; margin-top:0px;  background-color:#F0F0F0; font-size:14px; height:auto;border-radius: 4px; box-shadow: 0px 0px 4px #CCCCCC; float:left;  border: 1px #CCCCCC solid;">
	<tr><td>
	<table style="width:265px;margin-left:0px; margin-right:0px; margin-bottom:90px;margin-top:0px;">
	<tr>
	<td style="height:auto; border: 0px #CCCCCC solid; ">
<div style=" width:265px float:left; height:auto;  ">

<link rel="stylesheet" href="css_middle/style.css" type="text/css" />
<style type="text/css">
._css3m{display:none}
</style>
<ul id="css3menu11" class="topmenu" style="margin-top:18px;;border-radius: 14px;width:265px;border: 1px #CCCCCC solid; margin-left:0px;">
<li class="topfirst"><a href="EducationVerification.php" style="height:40px;line-height:40px; width:265px; border-radius:15px 15px 0px 0px;  background-color:#000000; color:#FFFFFF; border:#000000 0px solid;"><div style="padding-left:0px;"><b> &nbsp;Education Verification</b></div></a></li>

<li style="height:2px;width:265px;"></li>

	<li class="toplast"><a href="EmployeeVerification.php" style="height:40px;line-height:40px;margin-top:0px; width:265px;"><div style="padding-left:0px;"><b> &nbsp;Employee Verification</b></div></a></li>

<li style="height:2px;width:265px;"></li>

    <li class="topmenu"><a href="Employee&EducationVerification.php" style="height:40px;line-height:40px;margin-top:0px;margin-left:0px; width:265px;"><div style="padding-left:0px;"><b> &nbsp;Education+Employee Verification</b></div></a></li>
		...
		<!-- CLOSE TABLE 1--></table>
				...
				<!--TABLE 2--><table style="width:457px; background-color:#FFFFFF; font-size:14px; height:auto;border-radius: 4px; box-shadow: 0px 0px 4px #CCCCCC; float:left;  border: 1px #CCCCCC solid;">
	<tr><td>
	<table style="width:457px;margin-left:0px; margin-right:0px; margin-bottom:0px;margin-top:0px;">
	<tr>
	<td style="height:auto; border: 0px #CCCCCC solid; ">
...
$server=mysql_query("select * from static where page='EducationVarification'");
...
<strong style="width:255px; height:auto;border: 0px #CCCCCC solid; font-size:24px;" align="center"> <b>Total Amount</b></strong>
			<div style="width:255px; height:50px;border:solid 0px #999900;background-color:#EFEFEF; font-size:40px; border-radius:17px 17px 17px 17px;"align="center">
